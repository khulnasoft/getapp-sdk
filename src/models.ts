...
export namespace Models {
    ...
    export type Document = {
        ...
        $updatedAt: string;
        /**
         * Document permissions. [Learn more about permissions](https://getapp.io/docs/permissions).
         */
        $permissions: string[];
        [key: string]: any;
    }
    ...
    export type Log = {
        ...
        time: string;
        /**
         * Operating system code name. View list of [available options](https://github.com/getapp/getapp/blob/master/docs/lists/os.json).
         */
        osCode: string;
        /**
        ...
        clientType: string;
        /**
         * Client code name. View list of [available options](https://github.com/getapp/getapp/blob/master/docs/lists/clients.json).
         */
        clientCode: string;
        /**
         * Client name.
    ...
    export type File = {
        ...
        $updatedAt: string;
        /**
         * File permissions. [Learn more about permissions](https://getapp.io/docs/permissions).
         */
        $permissions: string[];
        /**
         * File name.
